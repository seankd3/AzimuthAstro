...
hdu = fits.PrimaryHDU(crop); hdu.header["XPIXSZ"] = 4.394; hdu.header["FOCALLEN"] = 16.0
hdu.writeto(path, overwrite=True)
fov = 2 * hh * 60.0 / 3600            # ~60"/px
...
cfg = json.load(open(f"{P.W}/project.json")); cfg["astap_center"] = [ra, dec]
